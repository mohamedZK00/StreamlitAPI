...
with st.sidebar:
    selected = option_menu('Multiple Student Grade Prediction System',
                           ['Prediction Of Total Grades for All Students & Statisticas', 'Predict Student Grades',
                            'Classification of Student Grades'],
                           icons=['percent', 'mortarboard-fill'],
                           default_index=0)

# Hide the main title and charts when 'Predict Student Grades' or 'Classification of Student Grades' is selected
...
if selected == 'Predict Student Grades':
    # Hide the main title and charts
    st.empty()
